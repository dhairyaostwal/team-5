...
function RedeemPoints() {
  return (
    ...
    <span class="category-name">Redeem Points</span> <br/><br/>
        ...
        <li>
            <div class="img-card iCard-style1">
                <div class="card-content">
                    ...
                    <div class="card-text">
                        <p>
                            After earning these many points you get special offers on udemy.
                        </p>
                    </div>
                ...
                <div class="card-link">
                    <a href="https://www.udemy.com/" title="Read Full" /><a>Check it out</a>for 500 points
                </div>
        ...
        <li>
            <div class="img-card iCard-style1">
                <div class="card-content">
                    ...
                    <div class="card-text">
                        <p>
                            After earning these many points you get special offers on coursera.
                        </p>
                    </div>
                ...
                <div class="card-link">
                    <a href="https://www.coursera.org/in" title="Read Full"/><a>Check it out</a> for 450 points
                </div>
        ...
        <li>
            <div class="img-card iCard-style1">
                <div class="card-content">
                    ...
                    <div class="card-text">
                        <p>
                            After earning these many points you get special offers on Edx.
                        </p>
                    </div>
                ...
                <div class="card-link">
                    <a href="https://www.edx.org/" title="Read Full"/><a>Check it out</a> for 300 points
                </div>
